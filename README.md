...
<footer class="back-tertiary color-secondary padded-hard text-center">
	<small>Developedi with &#9829; by <a href="YOUR WEBSITEr" target="_blank" title="b">YOUR WEBSITE</a> - <span id="year"></span></small>
</footer>
<!---------SCRIPTS--------->
...
<nav class="col-full" id="menu">
	<div class="col-3-quarter no-margin">
		<ul class="flex flex-row between no-margin col-full">
			...
			<li class="" onclick="darkMode();" title="Toggle Dark Mode"><i class="fa fa-fw fa-lightbulb-o"></i></li>
